...
import { womens_sari } from "../../../Data/women_sari";
import { filters, singleFilters, sortOption } from "./FilterData";
import {
  FormControl,
  FormControlLabel,
  FormLabel,
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
              ...
              <form className="hidden lg:block">
                <div className="flex justify-between items-center">
                  ...
                  <FilterAltTwoToneIcon className="opacity-40" />
                </div>
                {filters.map((section) => (
                  <Disclosure
                    key={section.id}
                  ...
                  >
                    ...
                    <DisclosurePanel className="option-item pt-6">
